...
//	public cvar_c.cvar_t con_notifytime = new cvar_c.cvar_t { name = "con_notifytime", value = (char)3 };
...
//	{
//		common_c.Q_memset(con_main.text, 0, Quake.console_c.CON_TEXTSIZE);
//		common_c.Q_memset(con_chat.text, 0, Quake.console_c.CON_TEXTSIZE);
//	}
