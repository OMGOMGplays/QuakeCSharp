...
//        drop->state = server_c.client_state_t.cs_zombie;
//        drop->connection_started = host_c.realtime;
...
//        SV_FullClientUpdate(drop, Quake.server_c.sv.reliable_datagram);
//    }
...
//    public static void SV_FullClientUpdate(server_c.client_t* client, common_c.sizebuf_t buf)
//    {
//        int i;
//        char info = '\0';

//        i = client - Quake.server_c.svs.clients;
