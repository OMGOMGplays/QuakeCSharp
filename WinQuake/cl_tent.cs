...
public unsafe class cl_tent_c
{
	...
	public static sound_c.sfx_t* cl_sfx_wizhit;
    public static sound_c.sfx_t* cl_sfx_knighthit;
    public static sound_c.sfx_t* cl_sfx_tink1;
    public static sound_c.sfx_t* cl_sfx_ric1;
    public static sound_c.sfx_t* cl_sfx_ric2;
    public static sound_c.sfx_t* cl_sfx_ric3;
    public static sound_c.sfx_t* cl_sfx_r_exp3;
#if QUAKE2
    public static sound_c.sfx_t* cl_sfx_imp;
	public static sound_c.sfx_t* cl_sfx_rail;
#endif
	...
	public void CL_ParseBeam(model_c.model_t* m)
	{
		...
		for (i = 0, b = cl_beams; i < client_c.MAX_BEAMS; i++, b++)
		{
			if (b->entity == ent)
			{
				b->entity = ent;
				b->model = m;
				b->endtime = (float)cl_main_c.cl.time + 0.2f;
	...
	public static void CL_ParseTEnt()
	{
		...
		switch (type)
		{
			case protocol_c.TE_WIZSPIKE:           // spike hitting wall
			...
			case protocol_c.TE_KNIGHTSPIKE:            // spike hitting wall
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
			...
			case protocol_c.TE_SPIKE:          // spike hitting wall
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
#if GLTEST
				...
				break;
			case protocol_c.TE_SUPERSPIKE:         // super spike hitting wall
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
			...
			case protocol_c.TE_GUNSHOT:            // bullet hitting wall
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
				R_RunParticleEffect(pos, mathlib_c.vec3_origin, 0, 20);
			...
			case protocol_c.TE_EXPLOSION:          // rocket explosion
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
				...
				dl->radius = 350;
				dl->die = (float)cl_main_c.cl.time + 0.5f;
				dl->decay = 300;
				S_StartSound(-1, 0, cl_sfx_r_exp3, pos, 1, 1);
				break;

			case protocol_c.TE_TAREXPLOSION:           // tarbaby explosion
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
				R_BlobExplosion(pos);
			...
			case protocol_c.TE_LIGHTNING1:             // lightning bolts
				CL_ParseBeam(model_c.Mod_ForName("progs/bolt.mdl", true));
				break;

			case protocol_c.TE_LIGHTNING2:             // lightning bolts
				CL_ParseBeam(model_c.Mod_ForName("progs/bolt2.mdl", true));
				break;

			case protocol_c.TE_LIGHTNING3:             // lightning bolts
				CL_ParseBeam(model_c.Mod_ForName("progs/bolt3.mdl", true));
				break;

			// PGM 01/21/97 
			case protocol_c.TE_BEAM:               // grappling hook beam
				CL_ParseBeam(model_c.Mod_ForName("progs/beam.mdl", true));
				break;
			// PGM 01/21/97

			case protocol_c.TE_LAVASPLASH:
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
				R_LavaSplash(pos);
			...
			case protocol_c.TE_EXPLOSION2:             // color mapped explosion
				pos[0] = common_c.MSG_ReadCoord();
				pos[1] = common_c.MSG_ReadCoord();
				pos[2] = common_c.MSG_ReadCoord();
